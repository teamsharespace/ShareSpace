...
export default async function Home() {
    ...
    return (
        <div className="min-h-screen">
            {/* Hero Section */}
            <section className="relative h-[950px] mb-40">
                <Image
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
                    <h1 className="text-4xl md:text-6xl -mt-36 font-bold text-center mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Button size="lg" className="bg-white text-black" variant="outline" asChild>
                            <Link href="/spaces">
